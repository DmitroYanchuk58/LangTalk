...
namespace WpfAppDiplomaDemo.HttpCommands
{
    ...
    {
        public static async Task<string> GetUser(Guid idUser)
        {
        ...
        public static async Task<string> GetUserInfo(Guid idUserInfo)
        {
        ...
        public static async Task<string> GetMbtiType(Guid idMbtiType)
        {
        ...
        public static async Task ChangeMbtiType(Guid idUserInfo, string mbtiType)
        {
            var response = await HttpCommand.SendPostHttpRequest($"/MbtiType/ChangeMbtiType?idUserInfo={idUserInfo}&mbtiType={mbtiType}", null);
            if (response.IsSuccessStatusCode)
            {
                return;
            }
        ...
        public static async Task<List<string>> GetAllMbtiTypes()
        {
        ...
        public static async Task<ChatModel> GetChat(Guid idChat)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var chat = System.Text.Json.JsonSerializer.Deserialize<ChatModel>(json, new System.Text.Json.JsonSerializerOptions
                {
